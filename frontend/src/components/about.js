        ...
        <main className="about-container" id="about">
            <div className="about-center-container">
                <div className="about-text-container">
                    ...
                    <p className="about-text">A highly dedicated aspiring full stack developer from Finland.</p>
                    <p className="about-text">               
                        I received my information technology bachelor from Tampere University in 2023.</p>
                    <p className="about-text">
                    A full stack developer with experience in plenty of languages and frameworks. Lately, I have developed a particular interest in the field of web development and in data analysis. 
